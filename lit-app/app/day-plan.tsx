          ...
          <FormScreen scrollPaddingBottom={mobile.formScrollPaddingBottom} contentContainerStyle={[formPageContent, styles.hudContent]}>
            ...
            >
              <View style={styles.checklistModalBackdrop}>
                <ScrollView style={styles.checklistModalPanel} contentContainerStyle={styles.checklistModalContent}>
                  {savedMessage ? (
                    <View style={styles.checklistSuccessBanner}>
                      <Text style={styles.checklistSuccessBannerText}>✓ {savedMessage}</Text>
                    </View>
                  ) : null}
                  {(() => {
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: "#4A3620", fontFamily: pixelFont, fontSize: 15, fontWeight: "900", letterSpacing: 0.5, lineHeight: 19, marginBottom: 6, textAlign: "center" },
  sectionMeta: { color: "#7C5B2B", fontSize: 11, fontWeight: "800", textAlign: "center", marginBottom: 8 },
  ...
  helperText: { color: "#4A3620", fontSize: 12, lineHeight: 18, marginBottom: 8, fontWeight: "700" },
  helperPill: { color: "#92610A", fontFamily: pixelFont, fontSize: 10, fontWeight: "900" },
  remainingTimeText: { color: "#92610A", fontFamily: pixelFont, fontSize: 11, fontWeight: "900", marginTop: 6, marginBottom: 8 },
  capMessage: { color: "#92610A", fontSize: 12, lineHeight: 17, fontWeight: "700", marginTop: 8 },
  recoveryWarning: { color: "#92400E", fontSize: 12, lineHeight: 17, fontWeight: "700", marginTop: 8 },
  input: { backgroundColor: "#F4E8CE", borderRadius: 7, padding: 12, fontSize: 15, color: "#4A3620", borderWidth: 2, borderColor: "#5C4425", fontWeight: "800" },
  itemInput: { marginVertical: 6 },
  emptyChecklist: { color: "#7C5B2B", fontSize: 13, lineHeight: 18, fontWeight: "700", marginBottom: 10, fontStyle: "italic" },
  timeStepperRow: { flexDirection: "row", alignItems: "center", justifyContent: "center", marginTop: 10 },
  timeStepButton: { width: 42, height: 36, borderWidth: 2, borderColor: "#92610A", alignItems: "center", justifyContent: "center", backgroundColor: "#F4E8CE" },
  timeStepText: { color: "#4A3620", fontFamily: pixelFont, fontSize: 18, fontWeight: "900" },
  timeValue: { flex: 1, color: "#4A3620", textAlign: "center", fontFamily: pixelFont, fontSize: 15, fontWeight: "900", borderBottomWidth: 1, borderBottomColor: "#5C4425", paddingVertical: 4 },
  timeError: { color: "#B3261E", fontFamily: pixelFont, fontSize: 10, textAlign: "center", marginTop: 4 },
  helperTextSubtle: { color: "#7C5B2B", fontSize: 11, lineHeight: 16, marginBottom: 8, fontWeight: "700" },
  rowBetween: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  checkCard: { backgroundColor: "#EAD9B6", borderWidth: 3, borderRadius: 8, padding: 10, marginBottom: 10, shadowColor: "#000", shadowOpacity: 0.5, shadowRadius: 0, shadowOffset: { width: 3, height: 3 } },
  progressBorder: { borderColor: "#FBBF24" },
  recoveryBorder: { borderColor: "#A78BFA" },
  hobbyBorder: { borderColor: "#F472B6" },
  checkToggle: { color: "#4A3620", fontSize: 24, marginRight: 8 },
  checkToggleDisabled: { color: "#A8916B" },
  checkboxGroup: { flexDirection: "row", alignItems: "center", flexShrink: 1 },
  checkHelperText: { color: "#7C5B2B", fontFamily: pixelFont, fontSize: 10, fontWeight: "700" },
  checkHelperTextDone: { color: "#14532D" },
  timerRequiredText: { color: "#92400E", fontSize: 10, lineHeight: 14, fontWeight: "700", marginTop: 4 },
  ...
  stepsText: { color: "#14532D", fontFamily: pixelFont, fontSize: 11, fontWeight: "900" },
  energyText: { color: "#92610A", fontFamily: pixelFont, fontSize: 11, fontWeight: "900" },
  weekdayLabel: { color: "#7C5B2B", fontFamily: pixelFont, fontSize: 10, fontWeight: "900", marginTop: 8, marginBottom: 4 },
  ...
  checkCardCompactTitle: { color: "#4A3620", fontFamily: pixelFont, fontSize: 13, fontWeight: "900" },
  checkCardCompactMeta: { color: "#7C5B2B", fontFamily: pixelFont, fontSize: 9, fontWeight: "700", marginTop: 2 },
  checkCardCompactArrow: { color: "#92610A", fontSize: 22, fontWeight: "900", marginLeft: 6 },
  ...
  hubCardTitle: { color: "#92610A", fontFamily: pixelFont, fontSize: 12, fontWeight: "900", marginRight: 8 },
  hubCardPreview: { flex: 1, color: "#4A3620", fontSize: 11, fontWeight: "700" },
  hubCardArrow: { color: "#92610A", fontSize: 22, fontWeight: "900", marginLeft: 6 },
  ...
  checklistModalPanel: { flex: 1, backgroundColor: "#EAD9B6", borderWidth: 3, borderColor: "#5C4425", borderRadius: 12 },
  checklistModalContent: { padding: 16 },
  checklistModalCloseBtn: { marginTop: 8, alignItems: "center", paddingVertical: 10 },
  checklistModalCloseBtnText: { color: "#5C4425", fontFamily: pixelFont, fontSize: 11, fontWeight: "900" },
  ...
  checklistSuccessBanner: { backgroundColor: "#DCFCE7", borderWidth: 2, borderColor: "#16A34A", borderRadius: 6, paddingVertical: 8, marginBottom: 10 },
  checklistSuccessBannerText: { color: "#14532D", fontFamily: pixelFont, fontSize: 11, fontWeight: "900", textAlign: "center" },
  ...
  panelGreen: { backgroundColor: "#EAD9B6", borderRadius: 8, padding: 12, marginBottom: 12, borderWidth: 3, borderColor: "#14532D" },
  ...
  saveQuestButton: { borderWidth: 3, borderColor: "#14532D", borderRadius: 6, backgroundColor: "#16A34A", paddingVertical: 10, alignItems: "center", marginTop: 10 },
