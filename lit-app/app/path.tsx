...
const styles = StyleSheet.create({
  ...
  profileButton: {
    ...
    paddingVertical: 10,
    alignItems: "center",
    backgroundColor: "rgba(61,42,26,0.75)",
    marginBottom: 4,
  },
  ...
  guideModalPanel: { flex: 1, backgroundColor: "rgba(46,32,20,0.98)", borderWidth: 3, borderColor: "#5C4425", borderRadius: 12 },
  ...
  resourceChipOff: {
    backgroundColor: "rgba(46,32,20, 0.60)",
    borderColor: "#3A4558",
    opacity: 0.5,
  },
  resourceChipIcon: {
  ...
  milestoneCard: {
    minHeight: 98,
    backgroundColor: "rgba(61, 42, 26, 0.92)",
    borderWidth: 2,
    borderColor: "#5C4425",
    borderRadius: 8,
    padding: 11,
