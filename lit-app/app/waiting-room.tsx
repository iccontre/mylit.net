...
const styles = StyleSheet.create({
  ...
  infoBtn: { width: 26, height: 26, borderWidth: 2, borderRadius: 13, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(46,32,20,0.7)" },
  ...
  guideAvatar: { width: 52, height: 60, borderRadius: 8, borderWidth: 2, marginRight: 12, backgroundColor: "rgba(46,32,20,0.6)" },
  guideCopy: { flex: 1 },
  ...
  missedBtn: { flex: 1, borderWidth: 2, borderRadius: 6, paddingVertical: 12, alignItems: "center", backgroundColor: "rgba(46,32,20,0.6)" },
